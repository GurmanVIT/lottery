                ...
                <div className="header_deposit">
                    ...
                    <div className='deposit_section'>
                        ...
                        <div className='precaution'>
                            <h5>Precaution</h5>
                            <p className='mb-2'>1. Please do not recharge non-USDT assets to the above address, otherwise the assets will not be retrieved. After recharging to the above address confirmation of the entire network node is required. The account will be received after 1 network confirmation, and the coin can be withdrawn After 1 network confirmation.</p>
