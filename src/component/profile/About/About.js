            ...
            <div className="about">
                <div className="header_about">
                    ...
                    <div className='about_section'>
                        <p className='privacy_policy'>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
                        <p className='interpretation'>Interpretation and Definitions</p>
                        <p className='interpretation'>Interpretation </p>
                        <p>The words of which the initial letter is capitalized have meanings defined under the following conditions.</p>
                        <p className='privacy_policy'>The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                        <p className='interpretation'>Definitions</p>
                        ...
                        <ul>
                            ...
                            <li><b> Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <Link to="/https://dapicgames.com/home_page">Dapicgames.</Link></li>
                            ...
                            <li><b>Website</b> refers to <Link to="/https://dapicgames.com/home_page">Dapicgames</Link>, accessible from <Link to="/https://dapicgames.com/home_page">http://dapicgames.in/</Link></li>
                            ...
                            <li className='mb-3'><b>Usage Data</b> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</li>
                        </ul>
                        <p className='interpretation'>Collecting and Using Your Personal Data</p>
                        <p className='interpretation'>Types of Data Collected</p>
                        <p className='interpretation'>Personal Data</p>
                        ...
                        <ul>
                            ...
                            <li className='privacy_policy'>Usage Data</li>
                        </ul>
                        <p className='interpretation'>Usage Data</p>
                        ...
                        <p className='privacy_policy'>We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.</p>
                        <p className='interpretation'>Tracking Technologies and Cookies</p>
                        <p>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service.</p>
                        <p>You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service.</p>
                        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer or mobile device when You go offline, while Session Cookies are de1eted as soon as You close your web browser.</p>
                        ...
                        <p className='privacy_policy'>For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy.</p>
                        <p className='interpretation'>Use of Your Personal Data</p>
                        ...
                        <ul>
                            ...
                            <li><b>To contact You:</b> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding upda7es or informative communications related to the functionalities, products or contracted services, including the security upda7es, when necessary or reasonable for their implementation.</li>
                        ...
                        <p className='interpretation'>Retention of Your Personal Data</p>
                        <p>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>
                        <p className='privacy_policy'>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>
                        <p className='interpretation'>Transfer of Your Personal Data</p>
